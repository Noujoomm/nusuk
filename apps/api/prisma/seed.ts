...
async function main() {
  ...
  // NOTE: No automatic task creation. Tasks are only created by explicit user action.
  // Previous seed logic that created 7 Gantt tasks in the consulting track has been removed
  // to prevent duplicate task creation on every deploy/restart.
