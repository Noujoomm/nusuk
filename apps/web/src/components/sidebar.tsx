...
const NAV_ITEMS = [
  ...
  { href: '/command-center', label: 'مركز القيادة الذكي', icon: Shield, roles: ['admin'] },
  ...
  { href: '/track-performance', label: 'أداء المسارات', icon: Target, roles: ['admin', 'pm'] },
  ...
  { href: '/ai-insights', label: 'الذكاء الاصطناعي', icon: Sparkles, roles: ['admin', 'pm'] },
